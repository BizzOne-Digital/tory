...
const PRODUCT_SEEDS = [
  // Hats
  {
    name: "Atelier Felt Fedora",
    slug: "atelier-felt-fedora",
    sku: "LC-HAT-001",
    priceMinor: 18500,
    featured: true,
    isNewArrival: true,
    ...
    images: [
      img(UNSPLASH.luxury4, "Felt fedora front"),
      img(UNSPLASH.detail1, "Fedora brim detail"),
    ],
    variants: [
      { name: "Size", options: ["S", "M", "L"], inventory: 20 },
      { name: "Colour", options: ["Ivory", "Sand", "Noir"], inventory: 20 },
    ],
  },
  {
    name: "Silk Band Cap",
    ...
    categories: ["Hats"],
    collections: ["Accessories"],
    images: [img(UNSPLASH.detail4, "Silk band cap")],
    variants: [
      { name: "Size", options: ["One Size"], inventory: 30 },
      { name: "Colour", options: ["Pearl", "Sage"], inventory: 30 },
    ],
  },
  {
    name: "Structured Beret",
    slug: "structured-beret",
    sku: "LC-HAT-003",
    priceMinor: 9800,
    categories: ["Hats"],
    collections: ["Accessories"],
    images: [img(UNSPLASH.luxury2, "Structured beret")],
    variants: [
      { name: "Colour", options: ["Black", "Camel", "Coral"], inventory: 24 },
    ],
  },
  // T-Shirts
  {
    ...
    collections: ["Basics"],
    images: [
      img(UNSPLASH.fashion5, "Essential cotton tee"),
      img(UNSPLASH.detail2, "Tee fabric detail"),
    ],
    variants: [
      { name: "Size", options: ["XS", "S", "M", "L", "XL"], inventory: 40 },
      { name: "Colour", options: ["Ivory", "Ink", "Sand"], inventory: 40 },
    ],
  },
  {
    name: "Relaxed Silk Tee",
    slug: "relaxed-silk-tee",
    sku: "LC-TEE-002",
    priceMinor: 14500,
    isNewArrival: true,
    seasonal: true,
    ...
    images: [img(UNSPLASH.fashion2, "Relaxed silk tee")],
    variants: [
      { name: "Size", options: ["XS", "S", "M", "L"], inventory: 28 },
      { name: "Colour", options: ["Pearl", "Aqua mist"], inventory: 28 },
    ],
  },
  {
    name: "Monogram Crew Tee",
    slug: "monogram-crew-tee",
    sku: "LC-TEE-003",
    priceMinor: 9800,
    featured: true,
    categories: ["T-Shirts"],
    collections: ["Basics"],
    images: [img(UNSPLASH.fashion4, "Monogram crew tee")],
    variants: [
      { name: "Size", options: ["S", "M", "L", "XL"], inventory: 35 },
      { name: "Colour", options: ["White", "Black", "Stone"], inventory: 35 },
    ],
  },
  // Sweaters
  {
    ...
    images: [
      img(UNSPLASH.luxury1, "Cashmere crew sweater"),
      img(UNSPLASH.detail3, "Knit texture"),
    ],
    variants: [
      { name: "Size", options: ["XS", "S", "M", "L"], inventory: 18 },
      { name: "Colour", options: ["Oat", "Slate", "Champagne"], inventory: 18 },
    ],
  },
  {
    ...
    categories: ["Sweaters"],
    collections: ["Knitwear"],
    images: [img(UNSPLASH.fashion3, "Merino turtleneck")],
    variants: [
      { name: "Size", options: ["S", "M", "L"], inventory: 16 },
      { name: "Colour", options: ["Ink", "Camel"], inventory: 16 },
    ],
  },
  {
    name: "Open-Knit Summer Sweater",
    slug: "open-knit-summer-sweater",
    sku: "LC-SWT-003",
    priceMinor: 24500,
    seasonal: true,
    categories: ["Sweaters"],
    collections: ["Summer Edit"],
    images: [img(UNSPLASH.luxury3, "Open-knit summer sweater")],
    variants: [
      { name: "Size", options: ["XS", "S", "M", "L"], inventory: 22 },
      { name: "Colour", options: ["Ivory", "Sage"], inventory: 22 },
    ],
  },
  // Sweatsuits
  {
    name: "Atelier Sweatsuit Set",
    slug: "atelier-sweatsuit-set",
    sku: "LC-SWTST-001",
    priceMinor: 29500,
    featured: true,
    isNewArrival: true,
    categories: ["Sweatsuits"],
    collections: ["Leisure"],
    images: [
      img(UNSPLASH.fashion1, "Atelier sweatsuit set"),
      img(UNSPLASH.editorial1, "Sweatsuit lifestyle"),
    ],
    variants: [
      { name: "Size", options: ["XS", "S", "M", "L", "XL"], inventory: 20 },
      { name: "Colour", options: ["Sand", "Charcoal", "Ivory"], inventory: 20 },
    ],
  },
  {
    name: "Wide-Leg Sweat Pant Set",
    slug: "wide-leg-sweat-pant-set",
    sku: "LC-SWTST-002",
    priceMinor: 26500,
    seasonal: true,
    categories: ["Sweatsuits"],
    collections: ["Leisure"],
    images: [img(UNSPLASH.fashion6, "Wide-leg sweat pant set")],
    variants: [
      { name: "Size", options: ["S", "M", "L"], inventory: 18 },
      { name: "Colour", options: ["Stone", "Noir"], inventory: 18 },
    ],
  },
  {
    name: "Hooded Lounge Suit",
    slug: "hooded-lounge-suit",
    sku: "LC-SWTST-003",
    priceMinor: 31500,
    categories: ["Sweatsuits"],
    collections: ["Leisure"],
    images: [img(UNSPLASH.editorial2, "Hooded lounge suit")],
    variants: [
      { name: "Size", options: ["XS", "S", "M", "L"], inventory: 14 },
      { name: "Colour", options: ["Oat", "Ink"], inventory: 14 },
    ],
  },
  // Denim
  {
    ...
    collections: ["Denim"],
    images: [
      img(UNSPLASH.fashion2, "High-rise straight denim"),
      img(UNSPLASH.detail2, "Denim wash detail"),
    ],
    variants: [
      { name: "Size", options: ["24", "25", "26", "27", "28", "29", "30"], inventory: 30 },
      { name: "Wash", options: ["Light", "Medium", "Indigo"], inventory: 30 },
    ],
  },
  {
    name: "Relaxed Barrel Jean",
    slug: "relaxed-barrel-jean",
    sku: "LC-DNM-002",
    priceMinor: 24500,
    isNewArrival: true,
    seasonal: true,
    categories: ["Denim"],
    collections: ["Denim"],
    images: [img(UNSPLASH.fashion4, "Relaxed barrel jean")],
    variants: [
      { name: "Size", options: ["24", "25", "26", "27", "28", "29"], inventory: 26 },
      { name: "Wash", options: ["Vintage", "Deep Indigo"], inventory: 26 },
    ],
  },
  {
    ...
    categories: ["Denim"],
    collections: ["Denim"],
    images: [img(UNSPLASH.fashion3, "Cropped denim jacket")],
    variants: [
      { name: "Size", options: ["XS", "S", "M", "L"], inventory: 20 },
      { name: "Wash", options: ["Soft Blue", "Black"], inventory: 20 },
    ],
  },
];
