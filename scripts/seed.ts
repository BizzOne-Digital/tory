...
const PRODUCT_SEEDS = [
  {
    ...
    slug: "silk-column-gown",
    sku: "LC-GWN-001",
    priceMinor: 248000,
    compareAtPriceMinor: 289000,
    featured: true,
    isNewArrival: true,
    seasonal: true,
    categories: ["Evening", "Gowns"],
    images: [
      img(UNSPLASH.fashion1, "Silk column gown front"),
      img(UNSPLASH.detail3, "Silk column gown detail"),
    ],
    variants: [
      { name: "Size", options: ["XS", "S", "M", "L"], inventory: 12 },
      {
        name: "Colour",
        options: ["Ivory", "Champagne", "Noir"],
        inventory: 12,
      },
    ],
  },
  {
    ...
    slug: "structured-atelier-blazer",
    sku: "LC-BLZ-002",
    priceMinor: 89500,
    featured: true,
    categories: ["Tailoring", "Outerwear"],
    images: [
      img(UNSPLASH.fashion3, "Structured blazer"),
      img(UNSPLASH.detail2, "Blazer lapel detail"),
    ],
    variants: [
      { name: "Size", options: ["34", "36", "38", "40", "42"], inventory: 20 },
      { name: "Colour", options: ["Charcoal", "Navy", "Camel"], inventory: 20 },
    ],
  },
  {
    ...
    sku: "LC-COT-003",
    priceMinor: 189500,
    compareAtPriceMinor: 210000,
    featured: false,
    isNewArrival: true,
    categories: ["Outerwear", "Winter"],
    images: [
      img(UNSPLASH.luxury1, "Cashmere wrap coat"),
      img(UNSPLASH.luxury3, "Coat texture"),
    ],
    variants: [
      { name: "Size", options: ["S", "M", "L"], inventory: 8 },
      { name: "Colour", options: ["Oat", "Slate", "Black"], inventory: 8 },
    ],
  },
  {
    ...
    sku: "LC-SKT-004",
    priceMinor: 42500,
    categories: ["Skirts", "Daywear"],
    images: [img(UNSPLASH.fashion4, "Pleated midi skirt")],
    variants: [
      { name: "Size", options: ["XS", "S", "M", "L", "XL"], inventory: 30 },
      { name: "Colour", options: ["Blush", "Forest", "Black"], inventory: 30 },
    ],
  },
  {
    name: "Signature Silk Blouse",
    slug: "signature-silk-blouse",
    sku: "LC-BLS-005",
    priceMinor: 38500,
    featured: true,
    seasonal: true,
    categories: ["Tops", "Silk"],
    images: [
      img(UNSPLASH.fashion5, "Signature silk blouse"),
      img(UNSPLASH.detail1, "Blouse cuff detail"),
    ],
    variants: [
      { name: "Size", options: ["XS", "S", "M", "L"], inventory: 25 },
      { name: "Colour", options: ["Pearl", "Sage", "Midnight"], inventory: 25 },
    ],
  },
  {
    ...
    sku: "LC-TRS-006",
    priceMinor: 52000,
    categories: ["Trousers", "Tailoring"],
    images: [img(UNSPLASH.fashion2, "Wide-leg trouser")],
    variants: [
      { name: "Size", options: ["34", "36", "38", "40"], inventory: 18 },
      { name: "Colour", options: ["Cream", "Black", "Stone"], inventory: 18 },
    ],
  },
  {
    name: "Evening Clutch — Embroidered",
    slug: "evening-clutch-embroidered",
    sku: "LC-ACC-007",
    priceMinor: 18500,
    isNewArrival: true,
    categories: ["Accessories"],
    images: [img(UNSPLASH.luxury4, "Embroidered evening clutch")],
    variants: [
      { name: "Colour", options: ["Gold", "Silver", "Onyx"], inventory: 15 },
    ],
  },
];
    ...
    await Product.findOneAndUpdate(
      { slug: p.slug },
      {
        $set: {
          ...
          description: `Crafted in our atelier with meticulous attention to fit, finish, and fabric.`,
          currency: "USD",
          status: "published",
          inventory: 10,
          materialCare: "Dry clean only. Store on padded hanger.",
